  ...
  module Record
    module Payroll
      ...
      class Employee < PayrollBase
        ...
        validates_length_of :first_name, :last_name, length: { maximum: 50 }, :allow_blank => true
        validates_length_of :title, length: { maximum: 10 }, :allow_blank => true
        validates_length_of :middle_names, :phone, :mobile, :twitter_user_name, :occupation, length: { maximum: 50 }, :allow_blank => true
        validates_length_of :email, :classification, length: { maximum: 100 }, :allow_blank => true
        validates_inclusion_of :gender, :in => %w{M F}, :message => "%{value} is not a valid gender value", :allow_blank => true
      end
